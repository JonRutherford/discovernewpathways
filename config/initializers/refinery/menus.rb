Refinery::Menus.configure do |config|
  ...
  # config.default_menus = {:refinery_page=>{:klass=>"Refinery::Page", :title_attr=>"title", :scope=>#<Proc:0x00000002893940@/home/kapachapow/.rvm/gems/ruby-1.9.3-p392@discover_new_pathways/gems/refinerycms-menus-2.0.7/lib/refinery/menus/configuration.rb:19>}, :refinery_resource=>{:klass=>"Refinery::Resource", :title_attr=>"file_name"}} 
end
